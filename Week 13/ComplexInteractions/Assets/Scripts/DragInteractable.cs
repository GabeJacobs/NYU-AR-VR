...
public class DragInteractable : XRBaseInteractable
{
    ...
    public static float InverseLerp(Vector3 a, Vector3 b, Vector3 value)
    {
        ...
        // gives the normalize 0-1 distance of value between a and b
    ...
    IEnumerator CalculateDrag()
    {
        while (m_interactor != null)
        {
            ...
            // convert out interactor position to local space
            ...
            // reverse interpolate that position on the line to get a percentage of how far the drag is
